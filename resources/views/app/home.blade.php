...
@section('body')
    ...
    <div class="mvv">
        <p class="Missão">Missão: Nosso objetivo é criar e fornecer quadros que inspirem, embelezem e tragam significado aos espaços. Buscamos oferecer produtos de alta qualidade e estilo para nossos clientes, contribuindo para a transformação de ambientes em locais inspiradores e acolhedores.
</p>
